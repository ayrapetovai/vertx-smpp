...
public class TlvTest {
    ...
    public void stringValue() throws Exception {
        ...
        Assert.assertNull(tlv0.getValueAsString());
    ...
    public void testEquals() {
        ...
        Assert.assertEquals(tlv0, tlv0);
        // Symmetry
        Assert.assertEquals(tlv0, tlv0Mirror);
        Assert.assertEquals(tlv0Mirror, tlv0);
        
        // Transitivity
        Tlv tlv0Transitive = new Tlv((short) 0x88, "equals".getBytes());
        Assert.assertEquals(tlv0, tlv0Transitive);
        Assert.assertEquals(tlv0Mirror, tlv0Transitive);

        // Non nullity
        Assert.assertNotEquals(null, tlv0);
